...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "AspNetUsers" DROP COLUMN "AccountVerified";
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Username" TYPE character varying(255);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Role" TYPE character varying(255);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Phone" TYPE character varying(20);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Number" TYPE character varying(255);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Email" TYPE character varying(255);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "SystemUsers" ALTER COLUMN "Address" TYPE character varying(5550);
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
ALTER TABLE "AspNetUsers" ALTER COLUMN "Domain" TYPE character varying(500);
END IF;
END $EF$;
...
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123091626_VerifiedMigration') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251123091626_VerifiedMigration', '9.0.9');
END IF;
END $EF$;
...
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206185955_TempCustomerMigration') THEN
ALTER TABLE "Subscriptions"
    ADD "UnsubscribedTime" timestamp with time zone;
END IF;
END $EF$;
...
(
    ...
    CONSTRAINT "PK_TempCustomers" PRIMARY KEY ("Id")
);
END IF;
END $EF$;
...
NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206185955_TempCustomerMigration') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251206185955_TempCustomerMigration', '9.0.9');
END IF;
END $EF$;
COMMIT;
